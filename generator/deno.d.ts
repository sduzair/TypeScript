...
declare namespace Deno {
   ...
   * mapping.
   *
   * `opt.uid` sets the child processΓÇÖs user ID. This translates to a setuid call
  ...
  export interface CommandOptions {
    ...
    env?: Record<string, string>;
    /**
     * Sets the child processΓÇÖs user ID. This translates to a setuid call in the
...
declare namespace WebAssembly {
  ...
  export class Global {
    ...
    /**
     * The value contained inside the global variable ΓÇö this can be used to directly set
   ...
   * by the browser ΓÇö this can be efficiently shared with Workers, and instantiated multiple times.
   *
  ...
  /**
   * The `WebAssembly.Table()` object is a JavaScript wrapper object ΓÇö an array-like structure
...
declare namespace Temporal {
   ...
   * concept of a time as expressed in everyday usage ΓÇö the time that you read
